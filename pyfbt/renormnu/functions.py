...
from renormnu.geo_const import mp_calc_constants
from renormnu.geo_freq import mp_boyer_freqs, mp_radial_roots, mp_mino_freqs
from renormnu.swsh_leaver import swsh_eigen, swsh_constants
...
def calc_nu(aa, slr, ecc, x, ell, en, em, kay, digits=100, ess=-2, M=1):
    ...
    return float(re_nu) + 1j*float(im_nu)
